...
const WhoWeAre = props => {
    ...
    return <div style={{ paddingTop: `${match ? `5.47em` : `0px`}`, backgroundColor: `${match ? `#e1ebff` : `#f0f3f9`}` }}>
                    ...
                    <div className="col-xl-11 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div className="row">
                            ...
                            <div className="offset-lg-2 col-lg-8 col-md-12 col-sm-12 col-12">
                                <p><strong>Collectively, the Verre Vert team brings decades of leadership and expertise from top-tier hospitality teams and world-className businesses.</strong></p>
                                <p>Prepared with experience founding multiple wine companies, leading three-Michelin starred restaurants, and advising Fortune 50 companies on strategy and management, the Verre Vert team understands the wine industry - and what it takes to transform it for the better.</p>
                            </div>
                        </div>
                        <div className="row pt-5em strengths">
                            <div className="offset-lg-2 col-lg-10 col-md-12 col-sm-12 col-12">
                                    ...
                                    <div className="col-xl-12 col-lg-7 col-md-7 col-sm-12 col-12">
                                        <div className="row gy-5">
                                            ...
                                            <div className="col-xl-4 col-lg-12 col-md-12 col-sm-12 col-12">
                                                ...
                                                <p>PhD in Chemical Engineering, Stanford University.</p>
                                            </div>
                                            <div className="col-xl-4 col-lg-12 col-md-12 col-sm-12 col-12">
                                ...
                                <a href="#" className="btn btn-primary rounded-pill">Meet The Team</a>
                            </div>
                        </div>
                    </div>
                </div>

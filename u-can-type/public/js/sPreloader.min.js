(function($){ document.getElementById("main-overflow").className = "hide_scroll"; var items=new Array(),errors=new Array(),onComplete=function(){},current=0;var jpreOptions={preMainSection:'#main-preloader',prePerText:'.preloader-percentage-text',preBar:'.preloader-bar',showPercentage:true,debugMode:false,splashFunction:function(){}}
...
var loadComplete=function(){$(jBar).stop().animate({width:'100%'},500,'linear',function(){$(jOverlay).fadeOut(800,function(){onComplete(); document.getElementById("main-overflow").className = "";});});}
